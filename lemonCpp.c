...
static char headerTopBuf[50000];
...
void print_stack_union(
  ...
  */
  ...
  sprintf(headerTopBuf,"#define %sTOKENTYPE %s\n",name, lemp->tokentype?lemp->tokentype:"void*"); /* NMS */ 
  lineno++;
  if( mhflag ){ fprintf(out,"#endif\n"); lineno++; }
  fprintf(out,"typedef struct {\n"); lineno++;	/* NMS it was union */
...
void ReportTable(
  ...
  ** empty actions. */
  ...
  /* append class body */
  printClassBody(out, lemp, &lineno);
